# EasierShulkers (NeoForge) ![](http://cf.way2muchnoise.eu/full_easier-shulkers_downloads.svg)
...
This is the NeoForge port, targeting Minecraft 26.2. For the Forge (Minecraft 1.21) version, see [`../EasierShulkers`](../EasierShulkers).
